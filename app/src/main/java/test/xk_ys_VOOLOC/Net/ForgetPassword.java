...
/**
 * Created by 柯东煜 on 2017/12/22.
 */

public class ForgetPassword extends BaseNet {
    private final String GG="http://123.207.57.91:8080/WooLock/Home/User/changePassword";
    private final String JY="http://120.77.211.48/WooLock.php/Home/user/forgetPassword";
    private Handler handler=new Handler();
    private Map<String,String> map=new HashMap<>();
    private Context context;
    public ForgetPassword(Context context,String account,String code,String newPassword){
